...
namespace Gitenax.Toolset.Editor
{
    ...
    public sealed class TransformInspector : UnityEditor.Editor
    {
	    ...
	    /// <summary>Draw the inspector widget</summary>
	    ...
	    /// <summary>Because Mathf.Approximately is too sensitive</summary>
        private static bool Differs (float a, float b) => Mathf.Abs(a - b) > 0.0001f;
